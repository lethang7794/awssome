...
1. <Link href="/DVA-C02/03-Cloud-Networking-TechFundamentals" target="_blank">Cloud, Networking, Tech Fundamentals</Link>

   Content: OSI, Other Networking; Security, DNS/DNSSec; Container & Virtualization; Backup & Disaster Recovery (DR), JSON/YAML...

2. <Link href="/DVA-C02/04-AWS-Fundamentals" target="_blank">AWS Fundamentals</Link>

   Content: Public/Private Services; HA/FT/DR; Route 53, DNS Records...

   Services: AWS Global Infrastructure; VPC, EC2, S3, CloudWatch

3. <Link href="/DVA-C02/06-IAM-Accounts-and-AWS-Organizations" target="_blank">IAM, AWS Accounts and AWS Organizations</Link>
...
4. <Link href="/DVA-C02/07-S3" target="_blank">S3</Link>

   Services: S3, KMS

5. <Link href="/DVA-C02/08-Security" target="_blank">Security</Link>
...
6. <Link href="/DVA-C02/09-VPC-Basics" target="_blank">VPC Basics</Link>
...
7. <Link href="/DVA-C02/10-EC2-Basics" target="_blank">EC2 Basics</Link>
...
8. <Link href="/DVA-C02/11-Monitoring-and-Logging" target="_blank">Monitoring and Logging</Link>

   Services: CloudWatch Logs, CloudWatch; X-Ray; VPC Flow Logs; AWS Config

   Multi sheets: CloudWatch Logs, CloudWatch

9. <Link href="/DVA-C02/12-Containers-ECS-ECR" target="_blank">Containers, ECS, ECR</Link>

   Content: Containers, K8s

   Services: ECS, ECR, EKS

10. <Link href="/DVA-C02/13-Advanced-EC2" target="_blank">Advanced EC2</Link>
...
11. <Link href="/DVA-C02/14-Infrastructure-as-Code-and-CloudFormation" target="_blank">Infrastructure as Code, CloudFormation</Link>

    Services: CloudFormation

12. <Link href="/DVA-C02/15-GlobalServiceDiscovery-ContentDelivery-Route53-CloudFront" target="_blank">Global Service Discovery, Content Delivery: Route 53, CloudFront...</Link>
...
13. <Link href="/DVA-C02/16-Databases-SQL" target="_blank">Databases - SQL</Link>

    Services: RDS, Aurora; Secrets Manager; DMS, SCT

    Multi sheets: Databases, RDS, Aurora, Secrets Manager

14. <Link href="/DVA-C02/17-Network-Storage" target="_blank">Network Storage</Link>

    Services: EFS, FSx

    Multi sheets: EFS, FSx

15. <Link href="/DVA-C02/18-Scaling-LoadBalancing-HighAvailability" target="_blank">Scaling, Load Balancing, High Availability</Link>
...
16. <Link href="/DVA-C02/19-AWS-CLI-DeveloperTools-CICD" target="_blank">AWS CLI, Developer Tools, CI-CD</Link>

    Services: CodeCommit, CodeBuild, CodeDeploy, CodePipeline, Code\*...

17. <Link href="/DVA-C02/20-ApplicationServices-EventDriven-Serverless" target="_blank">Application Services, Event Driven, Serverless</Link>

    Content: Software Architecture

    Services: Lambda; EventBridge; SNS, SQS; Step Functions; API Gateway; Kinesis; Cognito; MQ; Glue; AppFlow; SAM

18. <Link href="/DVA-C02/24-NoSQL-Databases-DynamoDB" target="_blank">NoSQL Databases - DynamoDB</Link>

    Services: DynamoDB, ElastiCache, Athena, Redshift

    Multi sheets: DynamoDB

19. <Link href="/DVA-C02/25-Elastic-Beanstalk" target="_blank">Elastic Beanstalk</Link>

    Services: Elastic Beanstalk


> Note: Each mind map can have more than one sheets.
...
See [README](https://github.com/lethang7794/AWSsome)
